There was a problem as it says, due to deployement of the project, the API key is disabled by the OpenAI itself. The proof is attache din the below printed mail.
